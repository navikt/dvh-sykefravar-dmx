...
vedtak_bygg AS ( select
    ...
    json_value(vedtak.kafka_message,'$.dokumenter[1].dokumentId') as dokument_soknad_id,
    json_value(vedtak.kafka_message,'$.dokumenter[0].dokumentId') as dokument_sykemelding_id,
    vedtak.kafka_topic,
